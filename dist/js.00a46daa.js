...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/utils/shift.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.shiftItems = void 0;
var shiftItems = function shiftItems(_ref) {
  var hoveredItem = _ref.hoveredItem,
    _ref$type = _ref.type,
    type = _ref$type === void 0 ? "shift" : _ref$type;
  try {
    var prevSibling = hoveredItem.previousElementSibling;
    var nextSibling = hoveredItem.nextElementSibling;
    if (type === "shift") {
    ...
    alert("Error in 'shiftItems' function: ".concat(error.message));
  }
};
exports.shiftItems = shiftItems;
},{}],"js/index.js":[function(require,module,exports) {
"use strict";

var _shift = require("./utils/shift");
var MAX_ITEMS = 100;
var listContainer = document.getElementById('list-container');
var dimmedBackground = document.querySelector('.overlay');
var listItems = [];
...
var onOverlayIn = function onOverlayIn() {
  try {
    var currentItem = document.querySelector('.clicked');
    ...
    alert("Error in 'onOverlayIn' function: ".concat(error.message));
  }
};
var onOverlayOut = function onOverlayOut(event) {
  try {
    ...
    alert("Error in 'onOverlayOut' function: ".concat(error.message));
  }
};
var onClickItem = function onClickItem(event) {
  try {
    ...
    alert("Error in 'onClickItem' function: ".concat(error.message));
  }
};
var createListItem = function createListItem(text) {
  try {
    ...
    alert("Error in 'createListItem' function: ".concat(error.message));
  }
};
for (var i = 1; i <= MAX_ITEMS; i++) {
  var li = createListItem("List Item ".concat(i));
  listItems.push(li);
}
listContainer.append.apply(listContainer, listItems);
},{"./utils/shift":"js/utils/shift.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
